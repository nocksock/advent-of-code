...
export const complement = f => (...args) => !f.apply(this, args)
...
export const tapLog = prefix => (...args) => {
  if (args.length > 1) console.warn('Note: tapLog has been called with more than 1 argument')
